Instructions for installing TensorFlow 2.13.0 for Cirrus GPU nodes
==================================================================
...
A user may build a local Python environment based on this module, `tensorflow/2.13.0-gpu`, which
...
activate script such that the `tensorflow/2.13.0-gpu` module is loaded during activation and unloaded
during deactivation.
...
CMDS="${MARK}\n\n"
CMDS="${CMDS}module -s load tensorflow/2.13.0-gpu\n\n"
...
CMDS="${CMDS}${INDENT}module -s unload tensorflow/2.13.0-gpu"
