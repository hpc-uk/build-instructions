Instructions for building Spindle 0.14rc1 on ARCHER2
====================================================

These instructions are for building Spindle 0.14rc1 on the ARCHER2 full system (HPE Cray EX, AMD Zen2 7742).
...
*Slurm support was requested, but slurm 22.05.11, which is later than 20.11, was detected.
...
source ${HOME/home/work}/tools/spindle/0.14rc1/env.sh
...
```bash
/dev/shm/spindle.88948/work/z19/z19/mrb23cab/tools/spindle/0.14rc1/lib/spindle/0-spindlens-file-libspindle_audit_pipe.so
...
