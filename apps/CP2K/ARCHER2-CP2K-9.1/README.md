...
This document provides instructions on how to build CP2K 9.1 and its
...
```
wget -O libxc-5.1.7.tar.gz https://www.tddft.org/programs/libxc/down.php?file=5.1.7/libxc-5.1.7.tar.gz
...
```
wget https://elpa.mpcdf.mpg.de/software/tarball-archive/Releases/2021.11.001/elpa-2021.11.001.tar.gz
