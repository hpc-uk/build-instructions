...
Instructions for installing the following software on [ARCHER2](https://docs.archer2.ac.uk/), HPE Cray EX, AMD Zen2 7742 CPU-based system: 
* preCICE v2.5.0 
* OpenFOAM v2212 
* OpenFOAM adapter for preCICE v1.2.2
* CalculiX v2.20 
